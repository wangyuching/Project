...
with mp_pose.Pose(min_detection_confidence=0.5,min_tracking_confidence=0.5) as pose:
    ...
    while cap.isOpened():
        ...
        if left_elbow_angle < 50 and left_distence < 150 :
            ...
            cv2.putText(img_bgr, "Eat Meduicine", (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 5, (255, 0, 0), 15)
        ...
        cv2.putText(img_bgr, f"Count: {count_eating_medicine}", (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 4)
        ...
        try:
            ...
            if current_timer_state == "DETECT":
                ...
                if is_eating_medicine and count_eating_medicine >= 2:
                    ...
                    print("END 2 - ALARM Timer Finished", end='\n\n')
                    current_timer_state = "DETECT"
                    detect_start_time = None
                    count_eating_medicine = 0
